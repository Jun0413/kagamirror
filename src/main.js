...
let mainWindow, wakeWordAgentProcess;
...
function startWakewordAgent() {
    console.log("startWakewordAgent() called");
    // spawn if needed
    wakeWordAgentProcess = exec("cd ~/FYP/alexa-avs-sample-app/samples/wakeWordAgent/src && ./wakeWordAgent -e kitt_ai");
}

function stopWakewordAgent() {
    console.log("stopWakeWordAgent() called");
    // console.log(wakeWordAgentProcess.pid);
    // wakeWordAgentProcess.kill();
    // console.log(wakeWordAgentProcess.killed);
    kill(wakeWordAgentProcess.pid, 'SIGKILL', function(err) {
        if (err) {
            console.log("[error] fail to kill wakeWordAgent");
            console.log(err);
        }
    });
}
...
function launchSpeechGrader() {
     ...
     */
    stopWakewordAgent();
    exec("lxterminal -t speechgrader -e ~/FYP/kagamirror-master/amadeus/launch.sh");
}
