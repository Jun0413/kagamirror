...
const thunderCloudSVG =
`<svg class="weather-icon thunder-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
...
const rainCloudSVG = 
`<svg class="weather-icon rain-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
...
const snowCloudSVG =
`<svg class="weather-icon snow-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
...
const sunCloudSVG =
`<svg class="weather-icon sun-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
...
const sunShineSVG =
`<svg class="weather-icon sunshine" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
...
const windyCloudSVG =
`<svg class="weather-icon windy-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
    <g class="cloud-wrap">
...
const beforeSVGHTML = `<div class="weather-desc"></div><div class="weather-iconinfo">`;
const afterSVGHTML = `<div class="weather-info"><div class="weather-temp"></div><div class="weather-loc"></div></div>`;
let weatherhandler = 0;
const weatherurl = "http://api.openweathermap.org/data/2.5/weather?id=1880251&APPID=875ddb05b8b2d307c74f84117d523f3e";
...
function startWeather(containerElement) {
    ...
    updateWeather();
    weatherhandler = setInterval(updateWeather, 3 * 60 * 60 * 1000);
}
    ...
    weatherRequest.onreadystatechange = function() {
        if (this.readyState === 4) {
            if (this.status === 200) {
                ...
                let svgHTML = whichSVG(response.weather[0].id);
                $(".weather-iconinfo").find('svg').remove();
                $(".weather-iconinfo").prepend(svgHTML);
                $(".weather-desc").html(`${mainweather} (${weatherdesc})`);
                $(".weather-temp").html(`${temp} &#8451;`);
                $(".weather-loc").html("Singapore");
...
/**
 * Conversion table: https://openweathermap.org/weather-conditions
 * Simplified as below:
 * 2xx - thunderCloud
 * 3xx, 5xx - rainCloud
 * 6xx - snowCloud
 ...
 * 800 - sunShine
 */
function whichSVG(id) {
    if (id == 800) return sunShineSVG;
    let firstDigit = parseInt(id/100);
    if (firstDigit == 2) {
        return thunderCloudSVG;
    } else if (firstDigit == 3 || firstDigit == 5) {
        return rainCloudSVG;
    } else if (firstDigit == 6) {
        return snowCloudSVG;
    } else if (firstDigit == 7 || firstDigit == 8) {
        return windyCloudSVG;
    } else {
        return "Error wtID";
    }
}
